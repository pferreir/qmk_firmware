...
#define DESCRIPTION     Lily58 is 6×4+5keys column-staggered split keyboard with RGB Support.
...
#define RGBLED_NUM 58    // Number of LEDs for Lily58+Glow
#define DRIVER_LED_TOTAL 58 // Number of LEDs for Lily58-Glow
